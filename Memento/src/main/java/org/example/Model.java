...
//    private StringProperty historyText ;
    ...
    public void restoreState(IMemento memento) {
        ...
        System.out.println("isSelected: " + isSelected);
        System.out.println(((Memento) memento).getName());
        System.out.println("State restored");
    }
//    public void setHistoryText(String value) { historyTextProperty().set(value); }
//    public String getHistoryText() { return historyTextProperty().get(); }
//    public StringProperty historyTextProperty() {
//        if (historyText == null) historyText = new SimpleStringProperty(this, "history Text");
//        return historyText;
//    }
}